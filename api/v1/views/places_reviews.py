...
def get_reviews(place_id=None):
    """
    Takes a place id and queries storage for the reviews of that place

    Args:
        place_id: id of place to search it's reviews

    Returns:
        list of reviews for the place in json format
    """
...
def post_review(place_id=None):
    """
    Takes an id and queries storgae for a place with that id,
    if found creates a review with the info recieve in the body of the request

    Args:
        place_id: place that review must be part of
